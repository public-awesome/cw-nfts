...
function createBaseCodeInfoResponse() {
    return { codeId: long_1.default.UZERO, creator: "", dataHash: new Uint8Array(), instantiatePermission: undefined };
}
...
class QueryClientImpl {
    ...
    PinnedCodes(request) {
        ...
        return promise.then((data) => exports.QueryPinnedCodesResponse.decode(new minimal_1.default.Reader(data)));
    }
}
