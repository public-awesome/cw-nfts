...
export declare const QueryEvidenceRequest: {
    ...
    fromPartial<I extends {
        ...
        evidenceHash?: Uint8Array | undefined;
    } & { [K in Exclude<keyof I, "evidenceHash">]: never; }>(object: I): QueryEvidenceRequest;
};
...
export declare const QueryAllEvidenceRequest: {
    ...
    } & { [K_3 in Exclude<keyof I, "pagination">]: never; }>(object: I): QueryAllEvidenceRequest;
};
export declare const QueryAllEvidenceResponse: {
    ...
    } & { [K_4 in Exclude<keyof I, keyof QueryAllEvidenceResponse>]: never; }>(object: I): QueryAllEvidenceResponse;
};
