...
pub use crate::state::{Cw721Contract, DefaultOptionalCw721Contract, EmptyOptionalCw721Contract};
...
pub mod entry {
    ...
    use state::EmptyOptionalCw721Contract;
    ...
    pub fn instantiate(
        ...
        let contract = EmptyOptionalCw721Contract::default();
