# CW1155 Metadata Onchain

Token creators may want to store their token metadata on-chain so other contracts are able to interact with it.
With CW1155-Base in CosmWasm, we allow you to store any data on chain you wish, using a generic `extension: T`.
...
Feel free to use this contract out of the box, or as inspiration for further customization of cw1155-base.
