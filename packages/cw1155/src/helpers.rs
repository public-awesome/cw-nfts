...
use crate::{
    AllNftInfoResponse, Approval, ApprovedForAllResponse, ContractInfoResponse, Cw1155ExecuteMsg,
    Cw1155QueryMsg, NftInfoResponse, NumTokensResponse, OwnerOfResponse, TokensResponse,
};

/// Cw1155Contract is a wrapper around Addr that provides a lot of helpers
/// for working with this.
///
/// If you wish to persist this, convert to Cw1155CanonicalContract via .canonical()
...
impl Cw1155Contract {
    ...
    pub fn owner_of<Q: Querier, T: Into<String>>(
        ...
        let req = Cw1155QueryMsg::OwnerOf {
    ...
    pub fn approved_for_all<Q: Querier, T: Into<String>>(
        ...
        let req = Cw1155QueryMsg::ApprovedForAll {
            owner: owner.into(),
            include_expired: Some(include_expired),
            start_after,
            limit,
    ...
    pub fn num_tokens<Q: Querier>(&self, querier: &Q) -> StdResult<u64> {
        let req = Cw1155QueryMsg::NumTokens {
            token_id: "".into(),
        };
    ...
    pub fn nft_info<Q: Querier, T: Into<String>, U: DeserializeOwned>(
        ...
        let req = Cw1155QueryMsg::NftInfo {
            token_id: token_id.into(),
        };
        self.query(querier, req)
    }
    ...
    pub fn all_nft_info<Q: Querier, T: Into<String>, U: DeserializeOwned>(
        ...
        let req = Cw1155QueryMsg::AllNftInfo {
            token_id: token_id.into(),
            include_expired: Some(include_expired),
        };
        self.query(querier, req)
